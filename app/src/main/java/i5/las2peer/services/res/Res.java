...
public class Res extends RESTService {
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "370", version = "0.0.0",
          description = "",
          termsOfService = "",
          contact = @Contact(name = "", email = "CAEAddress@gmail.com") ,
          license = @License(name = "BSD",
              url = "https://github.com/PhilCAEOrg2/microservice-370/blob/master/LICENSE.txt") ) )
  @Path("/")
  ...
  @ApiOperation(value = "gettest/{id}", notes = " ")
  public Response gettest/{id}(@PathParam("id") String id, String body) {
